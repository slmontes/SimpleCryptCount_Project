...
if isequal(Type,'In vitro') 
    ...
    NumCrypts_InVitro_All = [];
    Circularity_InVitro_All = [];
    ...
    for w=1%:length(Ibw_bound)
        ...
        NumCrypts_InVitro_All{w,1}=NumCrypts_perMask;
        Circularity_InVitro_All{w,1}=Circularity_perMask;
        
    end
    
    NumCrypts=NumCrypts_InVitro_All;
    Circularity=Circularity_InVitro_All;
